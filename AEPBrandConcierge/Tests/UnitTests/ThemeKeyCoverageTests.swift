...
private extension ThemeKeyCoverageTests {
    ...
    static let supportedCSSKeyToThemePropertyPath: [String: String] = [
        ...
        "product-card-title-subtitle-spacing": "layout.productCardTitleSubtitleSpacing",
        "product-card-section-spacing": "layout.productCardSectionSpacing",
        "product-card-price-spacing": "layout.productCardPriceSpacing",
